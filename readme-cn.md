...
[![Go](https://github.com/hduhelp/go-zero/workflows/Go/badge.svg?branch=master)](https://github.com/hduhelp/go-zero/actions)
[![Go Report Card](https://goreportcard.com/badge/github.com/hduhelp/go-zero)](https://goreportcard.com/report/github.com/hduhelp/go-zero)
...
[![Release](https://img.shields.io/github/v/release/zeromicro/go-zero.svg?style=flat-square)](https://github.com/hduhelp/go-zero)
[![Go Reference](https://pkg.go.dev/badge/github.com/hduhelp/go-zero.svg)](https://pkg.go.dev/github.com/hduhelp/go-zero)
...
> 
> `GOPROXY=https://goproxy.cn/,direct go install github.com/hduhelp/go-zero/tools/goctl@latest`
> 
...
```shell
GO111MODULE=on GOPROXY=https://goproxy.cn/,direct go get -u github.com/hduhelp/go-zero
```
...
1. 安装 goctl 工具
    ...
    ```shell
    # Go 1.15 及之前版本
    GO111MODULE=on GOPROXY=https://goproxy.cn/,direct go get -u github.com/hduhelp/go-zero/tools/goctl@latest
...
如果贵公司也已使用 go-zero，欢迎在 [登记地址](https://github.com/hduhelp/go-zero/issues/602) 登记，仅仅为了推广，不做其它用途。
