...
```shell
go get -u github.com/hduhelp/go-zero
```
## Upgrade
...
```shell
go install github.com/hduhelp/go-zero/tools/goctl@latest
```
...
2. install goctl
   ...
   GO111MODULE=on go get -u github.com/hduhelp/go-zero/tools/goctl@latest
