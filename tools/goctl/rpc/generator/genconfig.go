...
import (
	...
	conf "github.com/hduhelp/go-zero/tools/goctl/config"
	"github.com/hduhelp/go-zero/tools/goctl/rpc/parser"
...
// see https://github.com/hduhelp/go-zero/tree/master/tools/goctl/config/config.go
